                ...
                {combinedData.map((vaccine) => (
                  ...
                  >
                    <div className="flex-1">
                      <h3 className={`text-xl ${STATUS_COLOR[vaccine.researchStatus]} font-semibold pb-2`}>
                    ...
                    <div className="flex flex-col lg:ml-6 lg:w-1/3">
                      <p className="text-lg text-gray-700 mb-4">
                        Data de início: {formatDate(vaccine.researchStartDate)}
                      </p>
                      <p className="text-lg text-gray-700 mb-4">
                        Status: {STATUS_TEXT[vaccine.researchStatus]}
                      </p>
